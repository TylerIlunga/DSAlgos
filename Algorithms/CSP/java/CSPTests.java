...
public class CSPTests {
     ...
     * 
     * @param soln        Full instantiation of variables to assigned values,
     *                    indexed by variable
    ...
    public void CSP_t0() {
        Set<DateConstraint> constraints = new HashSet<>(
                Arrays.asList(new UnaryDateConstraint(0, "==", LocalDate.of(2019, 1, 3))));

        // Date range of 2019-1-1 to 2019-1-5 in which the only meeting date
        // for 1 meeting can be on 2019-1-3
        List<LocalDate> solution = CSP.solve(1, // Number of meetings to schedule
    ...
    public void CSP_t1() {
        Set<DateConstraint> constraints = new HashSet<>(
                Arrays.asList(new UnaryDateConstraint(0, "==", LocalDate.of(2019, 1, 6))));

        // Date range of 2019-1-1 to 2019-1-5 in which the only meeting date
        // for 1 meeting can be on 2019-1-6, which is outside of the allowable
        // range, so no solution here!
        List<LocalDate> solution = CSP.solve(1, LocalDate.of(2019, 1, 1), LocalDate.of(2019, 1, 5), constraints);
    ...
    public void CSP_t3() {
        ...
        List<LocalDate> solution = CSP.solve(2, LocalDate.of(2019, 1, 1), LocalDate.of(2019, 1, 5), constraints);
    ...
    @Test
    public void CSP_t4() {
        Set<DateConstraint> constraints = new HashSet<>(Arrays.asList(
                new UnaryDateConstraint(0, "<=", LocalDate.of(2019, 1, 2)),
                new UnaryDateConstraint(1, "<=", LocalDate.of(2019, 1, 2)), new BinaryDateConstraint(0, "!=", 1)));
    ...
    @Test
    public void CSP_t5() {
        Set<DateConstraint> constraints = new HashSet<>(Arrays.asList(new BinaryDateConstraint(0, "!=", 1),
                new BinaryDateConstraint(0, "!=", 2), new BinaryDateConstraint(1, "!=", 2)));
        ...
        // date! (impossible)
        List<LocalDate> solution = CSP.solve(3, LocalDate.of(2019, 1, 1), LocalDate.of(2019, 1, 2), constraints);
    ...
    public void CSP_t6() {
        ...
        // date! (impossible)
        List<LocalDate> solution = CSP.solve(3, LocalDate.of(2019, 1, 1), LocalDate.of(2019, 1, 3), constraints);
    ...
    public void CSP_t7() {
        Set<DateConstraint> constraints = new HashSet<>(
                Arrays.asList(new BinaryDateConstraint(0, "!=", 1), new BinaryDateConstraint(1, "==", 2),
                        new BinaryDateConstraint(2, "!=", 3), new BinaryDateConstraint(3, "==", 4),
                        new BinaryDateConstraint(4, "<", 0), new BinaryDateConstraint(3, ">", 2)));

        // Here's a puzzle for you...
        List<LocalDate> solution = CSP.solve(5, LocalDate.of(2019, 1, 1), LocalDate.of(2019, 1, 3), constraints);
    ...
    public void CSP_t8() {
        Set<DateConstraint> constraints = new HashSet<>(
                Arrays.asList(new UnaryDateConstraint(0, ">", LocalDate.of(2019, 1, 1)),
                        ...
                        new UnaryDateConstraint(4, ">", LocalDate.of(2019, 5, 1)), new BinaryDateConstraint(0, ">", 4),
                        new BinaryDateConstraint(1, ">", 3), new BinaryDateConstraint(2, "!=", 3),
                        new BinaryDateConstraint(4, "!=", 0), new BinaryDateConstraint(3, ">", 2)));

        // This one's simple, but requires some NODE consistency
        // preprocessing to solve in a tractable amount of time
        List<LocalDate> solution = CSP.solve(5, LocalDate.of(2019, 1, 1), LocalDate.of(2019, 5, 15), constraints);
    ...
    public void CSP_t9() {
        ...
        // preprocessing to solve in a tractable amount of time
        List<LocalDate> solution = CSP.solve(5, LocalDate.of(2019, 1, 1), LocalDate.of(2019, 6, 30), constraints);
