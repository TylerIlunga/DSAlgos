...
public class MazeProblem {
     ...
     * 
     * @param foundKey Boolean representing whether the agent found the key or not.
    ...
    /**
     * Given a state, determine the cost for moving from the agent's current state
     * to the given state.
     *
     * @param state A state that represents an option that the agent can take from
     *              it's current state.
     *
